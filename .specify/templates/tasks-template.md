...
- [ ] T004 Define API contract change list and validation/error code matrix
- [ ] T005 Define clean architecture and hexagonal module boundaries in source tree
...
- [ ] T012 Define calendar integrity constraints (timezone, conflict, ordering)
- [ ] T013 Enforce Java and Spring Boot best-practice conventions in base modules
...
- [ ] T020 [US1] Add validation and deterministic error codes
- [ ] T021 [US1] Add structured audit logging for mutating operations
...
- [ ] TXXX [P] Add/update instrumentation for measurable success criteria
- [ ] TXXX [P] Add/update recurring baseline snapshot or report task for operational metrics
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Verify constitution compliance evidence in PR checklist
